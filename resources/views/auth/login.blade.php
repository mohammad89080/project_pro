       ...
       >
        <div class="container">
            <div class="row justify-content-center no-gutters vertical-align">
                <div class="col-lg-4 col-md-6 login-bg bg"
                    >
                    <div class="login-fancy"  style="background-image: url('https://www.google.com/url?sa=i&url=https%3A%2F%2Fwww.enerpize.com%2Fattendance-management%2F&psig=AOvVaw2SSht8VFTvqdeIXUVJR80g&ust=1700336701331000&source=images&cd=vfe&opi=89978449&ved=0CBEQjRxqFwoTCPCLnfrly4IDFQAAAAAdAAAAABAN');">
                        <h2 class="text-white mb-20">مرحبا بك!</h2>
                        <p class="mb-20 text-white">نظام إدارة الحضور والغياب</p>
